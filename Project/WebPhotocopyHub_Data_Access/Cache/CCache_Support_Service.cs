...
public static class CCache_Support_Service
{
    private static readonly object Obj_Lock = new();
    private static List<SupportService> Arr_Data = new();
    private static Dictionary<Guid, SupportService> Dic_Data_ID = new();

    public static void Load_Cache_Support_Service(IEnumerable<SupportService> p_arrData)
    {
        lock (Obj_Lock)
        {
            Arr_Data = p_arrData
    ...
    public static void Add_Data(SupportService p_objData)
    {
    ...
    public static void Update_Data(SupportService p_objData)
    {
        if (p_objData.Id == Guid.Empty)
        {
            return;
    ...
    public static SupportService? Get_Data_By_ID(Guid p_iAuto_ID)
    {
        lock (Obj_Lock)
        {
    ...
    public static List<SupportService> List_Data()
    {
        lock (Obj_Lock)
        {
